"""
Standalone evaluation script (can be run directly)
"""
import argparse
import os
import sys
...
from evaluation.dataset_loader import MOTDataset
from evaluation.metrics import evaluate_sequence
from evaluation.baselines import run_baseline_comparison
from evaluation.visualization import plot_metrics_comparison, create_comparison_video
